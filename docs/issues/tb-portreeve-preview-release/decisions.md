...
## Package each Desktop architecture around one explicit promoted CLI
...
**Promoted:** 2026-08-16. PR: #59.

---

## Separate hosted preparation evidence from public publication authority
...
**Promoted:** 2026-08-16. PR: 60.

## Bind Desktop update selection to the packaged release channel
...
## Keep maturity, channel, and trust visible as separate user facts
