...
## Rebuild claims table for canonical endpoint identity
...
**Promoted:** 2026-08-06. PR: #7.

---

## Normalize legacy service input to one canonical identity
...
## Content-address definitions and advertise registration separately
...
## Reject ambiguous names and hash with locale-independent ordering
...
## Keep stack coordination as overlays on canonical claims and leases
...
**Promoted:** 2026-08-06. PR: #8.

---

## Keep discovery scoped, deterministic, and authority-free
...
## Persist lost activations as non-live evidence outcomes
...
**Promoted:** 2026-08-06. PR: #11.

---

## Split stack-prune evidence planning from atomic deletion
...
## Expose aggregate stack status for trusted inspection surfaces
