...
| --- | --------------------------- | ------- | --- | --------------------------- |
| R1  | Definition and identity     | NOT YET | -   | Planned for P1-P2 / I-1     |
...
| R5  | Compatibility and migration | NOT YET | -   | Planned for P1-P2 / I-1     |
| R6  | Safety and recovery         | NOT YET | -   | Planned for P5-P6 / I-4-I-5 |
| R7  | Client, CLI, and protocol   | NOT YET | -   | Planned for P2-P4 / I-1-I-3 |
