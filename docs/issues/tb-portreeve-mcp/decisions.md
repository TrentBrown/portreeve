...
## Route consequential actions through daemon receipts and shared fixed-path document primitives
...
**Promoted:** 2026-08-11. PR: #46 https://github.com/TrentBrown/portreeve/pull/46.

---

## Keep launcher operation credentials in dedicated bridge-local custody
