...
| R6 | Electron security and freshness | PASS | [#4](https://github.com/TrentBrown/portreeve/pull/4) | Sandboxed local renderer, strict CSP/navigation/permission denial, main-frame IPC validation, reduced snapshots, non-overlapping five-second refresh, visibility pause, stale recovery, and packaged inspection pass |
